...
OUT_CSV="${OUT_CSV:-$RESULTS_HEURISTICS_DIR/sa_restricted_exact_S6_C4_P4.csv}"
OUT_CSV_HOUSE="${OUT_CSV_HOUSE:-$RESULTS_HEURISTICS_DIR/sa_restricted_exact_S6_C4_P4_by_house.csv}"
OUT_CSV_DIAG="${OUT_CSV_DIAG:-$RESULTS_HEURISTICS_DIR/sa_restricted_exact_S6_C4_P4_diagnostics.csv}"
OUT_CSV_DIAG_HOUSE="${OUT_CSV_DIAG_HOUSE:-$RESULTS_HEURISTICS_DIR/sa_restricted_exact_S6_C4_P4_diagnostics_by_house.csv}"
