...
OUT_CSV="${OUT_CSV:-$RESULTS_MODELS_DIR/optimal_match_LEXMMFPEA_S6_C4_P4.csv}"
OUT_CSV_HOUSE="${OUT_CSV_HOUSE:-$RESULTS_MODELS_DIR/optimal_match_LEXMMFPEA_S6_C4_P4_by_house.csv}"
