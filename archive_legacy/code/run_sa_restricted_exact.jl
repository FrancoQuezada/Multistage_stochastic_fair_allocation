...
function run_sa_restricted_exact_config_set(;
    ...
    out_csv::String = "sa_restricted_exact_report.csv",
    out_csv_house::String = "sa_restricted_exact_report_by_house.csv",
    out_csv_diag::String = "sa_restricted_exact_diagnostics.csv",
    out_csv_diag_house::String = "sa_restricted_exact_diagnostics_by_house.csv",
    ...
    println("Total configuraciones SA restringido exacto a ejecutar: ", length(configs))

    for (cfg_idx, cfg) in enumerate(configs)
        println(
            "Running SA restricted config ", cfg_idx, "/", length(configs),
        ...
        result = solve_sa_restricted_exact(inst)
        sol = result.restricted_sol
        metrics = _scenario_metrics(inst, sol, "SA")
        probs = metrics.probs
        total_prob = metrics.total_prob
        fairness_gap = result.diagnostics.sa_gap
...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    out_csv = get(ENV, "OUT_CSV", "sa_restricted_exact_report.csv")
    out_csv_house = get(ENV, "OUT_CSV_HOUSE", "sa_restricted_exact_report_by_house.csv")
    out_csv_diag = get(ENV, "OUT_CSV_DIAG", "sa_restricted_exact_diagnostics.csv")
    out_csv_diag_house = get(ENV, "OUT_CSV_DIAG_HOUSE", "sa_restricted_exact_diagnostics_by_house.csv")
    ...
    run_sa_restricted_exact_config_set(
